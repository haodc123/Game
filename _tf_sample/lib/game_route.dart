import 'package:tf_buttocks_time/ad_helper.dart';
import 'package:tf_buttocks_time/app_theme.dart';
...
class _GameRouteState extends State<GameRoute> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
        Uri.parse('https://en.tflash.online/game_m/buttocks-time-3d'),
      );
  ...
  void _createInterstitialAd() {
    InterstitialAd.load(
      adUnitId: "<YOUR_ANDROID_INTERSTITIAL_AD_UNIT_ID>",
      request: AdRequest(),
