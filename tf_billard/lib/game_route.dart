import 'package:tf_billard/ad_helper.dart';
import 'package:tf_billard/app_theme.dart';
...
class _GameRouteState extends State<GameRoute> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
        Uri.parse('https://en.tflash.online/game_m/3d-billiard-8-ball-pool'),
      );
  ...
  void _createInterstitialAd() {
    InterstitialAd.load(
      adUnitId: "ca-app-pub-7188489268015540/9331757319",
      request: AdRequest(),
