import 'package:tf_dinosaur/ad_helper.dart';
import 'package:tf_dinosaur/app_theme.dart';
...
class _GameRouteState extends State<GameRoute> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
        Uri.parse('https://en.tflash.online/game_m/dinosaur-game'),
      );
  ...
  void _createInterstitialAd() {
    InterstitialAd.load(
      adUnitId: "ca-app-pub-7188489268015540/2829766442",
      request: AdRequest(),
