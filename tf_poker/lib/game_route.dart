import 'package:tf_poker/ad_helper.dart';
import 'package:tf_poker/app_theme.dart';
...
class _GameRouteState extends State<GameRoute> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
        Uri.parse('https://en.tflash.online/game_m/goodgame-poker'),
      );
  ...
  void _createInterstitialAd() {
    InterstitialAd.load(
      adUnitId: "ca-app-pub-7188489268015540/1098044074",
      request: AdRequest(),
