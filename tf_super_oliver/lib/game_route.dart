import 'package:tf_super_oliver/ad_helper.dart';
import 'package:tf_super_oliver/app_theme.dart';
...
class _GameRouteState extends State<GameRoute> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
        Uri.parse('https://en.tflash.online/game_m/super-oliver-world'),
      );
  ...
  void _createInterstitialAd() {
    InterstitialAd.load(
      adUnitId: "ca-app-pub-7188489268015540/5915256482",
      request: AdRequest(),
