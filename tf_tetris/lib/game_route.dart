import 'package:tf_tetris/ad_helper.dart';
import 'package:tf_tetris/app_theme.dart';
...
class _GameRouteState extends State<GameRoute> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(
        Uri.parse('https://en.tflash.online/game_m/blocks-fill-tangram'),
      );
  ...
  void _createInterstitialAd() {
    InterstitialAd.load(
      adUnitId: "ca-app-pub-7188489268015540/5073566652",
      request: AdRequest(),
